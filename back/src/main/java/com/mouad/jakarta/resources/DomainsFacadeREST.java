...
public class DomainsFacadeREST extends AbstractFacade<Domains> {
    ...
    public void create(Domains entity) {
        super.create(entity);
    }
    ...
    public Domains find(@PathParam("id") Integer id) {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<Domains> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
